...
from .views import index, notifications_view, settings_view, mark_notification_read, add_expense, filter_dashboard_data, delete_all_data, landing, aboutus, delete_notification, delete_all_notifications, delete_budget, delete_transaction
